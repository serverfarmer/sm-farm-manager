...
path="/etc/local/.farm"
files="$path/backup.hosts $path/workstation.hosts $path/problematic.hosts $path/physical.hosts $path/virtual.hosts $path/docker.hosts $path/openvz.hosts $path/lxc.hosts $path/cloud.hosts $path/mikrotik.hosts $path/cisco.hosts"
...
ln -sf /opt/farm/ext/farm-manager/rename-host.sh /usr/local/bin/rename-host
