...
path="/etc/local/.farm"
files="$path/backup.hosts $path/workstation.hosts $path/problematic.hosts $path/physical.hosts $path/virtual.hosts $path/docker.hosts $path/openvz.hosts $path/lxc.hosts $path/ec2.hosts $path/mikrotik.hosts $path/cisco.hosts"
